...
export default function AboutPage() {
  return (
    <div className="flex w-full flex-col items-center py-4 text-center">
      ...
      >
        <PageMark kind="about" />
        <p className="type-eyebrow text-accent">{profile.pages.about.title}</p>

        <div className="relative mt-4 h-28 w-28 overflow-hidden rounded-full border border-border/80 bg-card/40 md:h-32 md:w-32">
          <Image
            src={brandAssets.profile}
            alt={profile.name}
            fill
            sizes="128px"
        ...
        <h1 className="mt-5 text-[clamp(1.35rem,3.2vw,1.9rem)] font-bold leading-tight tracking-tight text-foreground">
          {profile.about.hook}
        </h1>
        ...
        >
          <p className="font-mono text-xs uppercase tracking-[0.14em] text-accent">
            {profile.pages.about.optimizeFor}
          </p>
