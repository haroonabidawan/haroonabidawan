...
export function AppNav() {
  ...
  return (
    <nav
      ...
      aria-label="Site"
    >
      <div className="mx-auto flex max-w-5xl items-center gap-2 px-3 py-2 md:gap-3 md:px-5 md:py-2.5">
        ...
        <Link
          ...
          aria-label="Home"
        >
          <Image src="/logo.png" alt="" width={64} height={64} className="h-7 w-7 object-contain md:h-8 md:w-8" />
        </Link>
            ...
            {items.map(({ href, label }) => {
              ...
              return (
                <Link
                  ...
                  href={href}
                  className={[
                    "shrink-0 rounded-full px-2.5 py-1.5 font-mono text-[0.6rem] uppercase tracking-widest transition-all md:px-3 md:text-[0.65rem]",
                    active
                      ? "bg-card text-accent"
