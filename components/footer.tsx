...
export function Footer() {
  return (
    <footer className="relative py-12 px-6">
      {/* Top border */}
      <div className="absolute top-0 left-6 right-6 h-px bg-border opacity-50" />
      ...
      <div className="mx-auto max-w-3xl flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 font-mono text-[11px] text-muted-foreground">
          ...
          <span>2026 Haroon Abid Awan</span>
          <span className="hidden sm:inline text-border">|</span>
          <span className="hidden sm:inline">Portfolio coming soon</span>
        </div>
        ...
        >
          ...
          <span className="hidden sm:inline uppercase tracking-wider">LinkedIn</span>
        </a>
      </div>
    </footer>
  )
