...
export const profile = {
  ...
  brand: {
    name: "Carbon Trail",
    siteUrl: "https://haroonabidawan.com",
    domain: "haroonabidawan.com",
    logoAlt: "Carbon Trail",
    profileImage: "/brand/profile.webp",
  },
  hero: {
    greeting: "I'm",
    taglineLead: "Software you can run at midnight",
    taglineRest: "without holding your breath. Calm systems. Clear ownership.",
    taglineFull:
      "Software you can run at midnight without holding your breath. Calm systems. Clear ownership.",
    downloadCv: "Download CV",
    locationLine: "Manama, Bahrain | Open to relocate",
    homeOutro: [
  ...
  meta: {
    description:
      "Haroon Abid Awan, Senior Full Stack and AI Enabled Automation Engineer in Manama, Bahrain. GCC SaaS, EN/AR platforms, Laravel, NestJS, FastAPI, Benefit payments, and calm systems that ship.",
    openGraphDescription:
      "Software you can run at midnight without holding your breath. Calm systems. Clear ownership. Based in Bahrain, shipping across the GCC.",
    openGraphImage: "/opengraph-image",
  },
  seo: {
    locale: "en",
    alternateLocales: ["ar-BH", "ar-SA", "ar-AE"],
    titleDefault:
      "Haroon Abid Awan | Senior Full Stack Engineer · GCC SaaS & AI Automation",
    titleTemplate: "%s · Haroon Abid Awan",
    keywords: [
      "full stack engineer Bahrain",
      "GCC SaaS developer",
      "senior software engineer Manama",
      "Laravel developer GCC",
      "NestJS developer Bahrain",
      "FastAPI engineer GCC",
      "AI automation engineer Gulf",
      "multi-tenant SaaS developer",
      "EN AR web platform developer",
      "Benefit payment integration Bahrain",
      "hire full stack developer GCC",
      "Bespoke Marketing engineer",
      "RentIt HireMe SellIt developer",
    ],
    areaServed: [
    ...
    regionLabel: "Gulf Cooperation Council (GCC)",
    geo: {
      locality: "Manama",
    ...
    llms: {
      summary:
        "Senior Full Stack and AI Enabled Automation Engineer in Manama, Bahrain. Ships GCC SaaS, EN/AR platforms, and calm systems for HireMe, SellIt, RentIt, and Crisis Pass.",
      audience:
        "GCC founders, product teams, and hiring managers looking for a senior engineer or delivery partner across Bahrain, KSA, UAE, and the wider Gulf.",
      contactNote:
        "Send a brief with scope, timeline, stack preferences, and a 30-day success definition. Email, WhatsApp, and phone are on the contact page.",
    },
    faq: [
      {
        question: "Who is Haroon Abid Awan?",
        answer:
          "Haroon Abid Awan is a Senior Full Stack and AI Enabled Automation Engineer based in Manama, Bahrain, open to relocate across the GCC. He ships multi-tenant SaaS, EN/AR platforms, and automation that still runs at midnight.",
      },
      {
        question: "What GCC products has Haroon shipped?",
        answer:
          "Live GCC products include HireMe GCC, SellIt GCC, RentIt Bahrain, and Crisis Pass, plus Benefit and EasyPay commerce work, freelance sites, and internal CRM and automation systems.",
      },
      {
        question: "What services does Haroon offer?",
        answer:
          "Five lanes: consultancy, websites, web platforms, mobile apps, and custom systems. Scope covers architecture, Laravel, NestJS, FastAPI, gluestack, Benefit payments, Keycloak, n8n, and Ollama where they cut real work.",
      },
      {
        question: "How do I hire Haroon or start a project?",
        answer:
          "Use the contact page or email with a brief: what you are building, timeline, stack preferences, and how success looks in 30 days. Haroon replies with a clear next step when the fit is right.",
      },
      {
        question: "Which regions does Haroon serve?",
        answer:
          "Bahrain is the home base today, with delivery and relocation openness across the Gulf Cooperation Council: Bahrain, Saudi Arabia, UAE, Kuwait, Qatar, and Oman.",
      },
    ],
  },
  pages: {
    about: {
      title: "About",
      description:
        "Senior Full Stack and AI Enabled Automation Engineer in Manama, Bahrain. GCC SaaS, RentIt, Crisis Pass, SellIt, HireMe, and calm systems that still run at midnight.",
      optimizeFor: "What I optimize for",
    },
    contact: {
      title: "Contact",
      description:
        "Contact Haroon Abid Awan in Manama, Bahrain. Send a project brief for GCC SaaS, web platforms, mobile apps, or senior full stack roles. Open to relocate across the Gulf.",
      headline: "Send the brief. I'll reply with a clear next step.",
      fitLine: "If the fit is right, we kick off delivery.",
      briefLabel: "The brief",
      briefHint: "Four lines. Enough to start.",
      openToLabel: "Open to",
      openToHint:
        "Roles and contract spikes that match the brief. Project lanes live on",
      elsewhere: "Elsewhere",
      outroEyebrow: "Keep exploring",
    },
    work: {
      title: "Work",
      description:
        "Featured GCC products: HireMe GCC, SellIt GCC, Crisis Pass, and RentIt Bahrain. Live SaaS with tenancy, auth, EN/AR surfaces, and ops that still run at midnight.",
      h1: "Four products that carry the proof.",
      subtitle: "Live GCC products with tenancy, auth, and ops that still run at midnight.",
    },
    projects: {
      title: "Projects",
      description:
        "Full project list for GCC and regional clients. HireMe, SellIt, Crisis Pass, RentIt, Benefit checkout, freelance sites, and earlier shipped work with live links.",
      h1: "Every shipped product and engagement.",
      backLink: "Back to featured work",
    },
    experience: {
      title: "Experience",
      description:
        "Senior software engineering experience across Bahrain and the GCC. Bespoke Marketing, Nordic Holdings, Fathom Media, and earlier roles with problem, decision, outcome proof.",
      h1: "Where trust was earned.",
      subtitle: "Problem. Decision. Outcome. Follow the trail.",
    },
    toolkit: {
      title: "Toolkit",
      description:
        "Production stack for GCC products: Laravel, NestJS, FastAPI, gluestack, Benefit, EasyPay, Tap Payments, Keycloak, n8n, Ollama, AWS, and the tools behind live Gulf platforms.",
      h1: "The stack behind the products.",
      subtitle: "Production tools first. Roadmap second. Follow the trail.",
      learningLabel: "Planning to learn next",
    ...
    services: {
      title: "Services",
      description:
        "Full stack consultancy and delivery for GCC teams: SaaS platforms, EN/AR web apps, mobile backends, Benefit checkout, and custom systems. Five lanes. One owner.",
      openLane: "Open lane",
    },
    credits: {
      title: "Credits",
      ...
      h1: "Strong products are built by teams.",
      subtitle: "The people behind the brand, tone, and finish. Room for one more.",
    },
    privacy: {
      title: "Privacy",
      description:
        "Contact handling, Google Analytics 4 on this portfolio, and what I do with your data. Short, plain, and specific.",
      h1: "Clear ownership. Including your data.",
      subtitle: "Short page. No legal fog. What happens when you visit or reach out.",
    },
  },
  /** About page: one hook, then facts. Site copy source of truth. */
  about: {
  ...
  /** Skill groups mirror production stack. */
  skills: {
    "AI-enabled automation": [
      "n8n",
      "Ollama",
  ...
  /** Experience bullets for CV export and reference. */
  experience: [
    {
  ...
  /** Projects: public href when live. */
  projects: [
    {
      name: "HireMe GCC",
      tag: "Product",
